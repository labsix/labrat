...
#
#   Taken from github.com/techx/hackmit-hackbot, which is a modification of the
#   update script in github.com/github/hubot-scripts.
#
# Dependencies:
#   None
#
...
#
# Author:
#   benjamine, Detry322, anishathalye
